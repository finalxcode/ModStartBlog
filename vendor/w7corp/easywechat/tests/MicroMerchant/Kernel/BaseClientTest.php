...
class BaseClientTest extends TestCase
{
    public function testRequest()
    {
        ...
        $client->expects()->castResponseToType()->with($mockResponse, \Mockery::any())->times(3)->andReturn(['foo' => 'mock-bar', 'return_code' => '1212']);
    ...
    {
        $app = new Application(['app_id' => 'wx123456', 'cert_path' => 'foo', 'key_path' => 'bar']);
    ...
    public function testBodySign($signType, $nonceStr, $sign)
    {
        ...
        $api = 'http://easywechat.org';
        $params = ['foo' => 'bar', 'nonce_str' => $nonceStr, 'sign_type' => $signType];
        $method = \Mockery::anyOf(['get', 'post']);
        $options = [];
        $mockResponse = new Response(200, [], 'response-content');
    ...
    {
        return [['', '5c3bfd3227348', '82125D68D3C25B2B78D53F66E12EC89A'], ['MD5', '5c3bfe0343bab', 'A9237F1A2DF77FF900CFFB7B432CD1A9'], ['HMAC-SHA256', '5c3bfe6716023', 'A890BD78E9B1563C546D07F21E8C8D96B146CFE5B18941C312678B5636263DE6']];
    }
