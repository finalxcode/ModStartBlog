...
class ClientTest extends TestCase
{
    ...
    public function testApplyEnter()
    {
        ...
        $params = ['business_code' => '122222', 'id_card_copy' => '111'];
    ...
    public function testUpgrade()
    {
        ...
        $params = ['sub_mch_id' => 'sub_mch_id', 'organization_type' => 2, 'business_license_copy' => '2ewajkfjskdjfi3ji4jf93wi4j3438348932nnd'];
