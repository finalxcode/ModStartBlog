...
class ClientTest extends TestCase
{
    ...
    {
        return new Application(['mch_id' => 'mock-mch_id', 'key' => 'mock-key123456789101234567891011']);
    }
    ...
    public function testAddPayAccreditDirectory()
    {
        ...
        $client->expects()->safeRequest('secapi/mch/addsubdevconfig', ['appid' => $appid, 'sub_mch_id' => $sub_mch_id, 'jsapi_path' => $jsapi_path])->andReturn('mock-result');
    ...
    public function testBindAppid()
    {
        ...
        $appid = 'sdasdfasdf23232';
        $sub_mch_id = '232423423';
        $client->expects()->safeRequest('secapi/mch/addsubdevconfig', ['appid' => $appid, 'sub_mch_id' => $sub_mch_id, 'sub_appid' => $sub_appid])->andReturn('mock-result');
