...
class ClientTest extends TestCase
{
    public function testAdd()
    {
        ...
        $calendar = ['organizer' => 'userid1', 'summary' => 'test_summary', 'color' => '#FF3030', 'description' => 'test_describe', 'shares' => [['userid' => 'userid2'], ['userid' => 'userid3']]];
    ...
    {
        $client = $this->mockApiClient(Client::class);
        $data = ['summary' => 'test_summary', 'color' => '#FF3030', 'description' => 'test_describe', 'shares' => [['userid' => 'userid2'], ['userid' => 'userid3']]];
    ...
    {
        $client = $this->mockApiClient(Client::class);
        $client->expects()->httpPostJson('cgi-bin/oa/calendar/get', ['cal_id_list' => ['mock-id1']])->times(2)->andReturn('mock-result');
        // string
    ...
    {
        $client = $this->mockApiClient(Client::class);
        $client->expects()->httpPostJson('cgi-bin/oa/calendar/del', ['cal_id' => 'mock-id'])->andReturn('mock-result');
