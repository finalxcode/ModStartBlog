...
class NewsTest extends TestCase
{
    ...
    {
        $items = [new NewsItem(['title' => 'mock-title', 'description' => 'mock-description', 'url' => 'mock-url', 'image' => 'mock-picurl'])];
        $news = new News($items);
        $message = ['msgtype' => 'news', 'news' => ['articles' => [['title' => 'mock-title', 'description' => 'mock-description', 'url' => 'mock-url', 'picurl' => 'mock-picurl']]]];
