...
class MessengerTest extends TestCase
{
    ...
    public function testSecretive()
    {
        ...
        $message = new Raw(json_encode(['touser' => '@all', 'msgtype' => 'text', 'agentid' => 123456, 'safe' => 0, 'text' => ['content' => 'hello world!']]));
        $client->expects()->send(['touser' => '@all', 'msgtype' => 'text', 'agentid' => 123456, 'safe' => 0, 'text' => ['content' => 'hello world!']])->andReturn('mock-result');
