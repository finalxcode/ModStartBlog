...
class ClientTest extends TestCase
{
    public function testGet()
    {
        ...
        $client->expects()->requestRaw('cgi-bin/media/get', 'GET', ['query' => ['media_id' => $mediaId]])->andReturn($imageResponse);
    ...
    public function testUpload()
    {
        ...
        $client->expects()->httpUpload('cgi-bin/media/upload', ['media' => '/foo/bar/voice.mp3'], [], ['type' => 'voice'])->andReturn('mock-result');
