...
class ApplicationTest extends TestCase
{
    ...
    {
        $app = new Application(['corp_id' => 'xwnaka223', 'agent_id' => 102093, 'secret' => 'secret']);
    ...
    {
        $app = new Application(['response_type' => 'array', 'log' => ['level' => 'debug', 'permission' => 0777, 'file' => '/tmp/easywechat.log'], 'debug' => true, 'corp_id' => 'corp-id', 'agent_id' => 100020, 'secret' => 'secret']);
        ...
        $this->assertArraySubset(['response_type' => 'array', 'log' => ['level' => 'debug', 'permission' => 0777, 'file' => '/tmp/easywechat.log'], 'debug' => true, 'corp_id' => 'corp-id', 'agent_id' => 100020, 'secret' => 'secret'], $miniProgram->config->toArray());
    }
