...
class AccessTokenTest extends TestCase
{
    public function testGetCredentials()
    {
        ...
        $app = new ServiceContainer(['suite_id' => 'mock-suite-id', 'suite_secret' => 'mock-suite-secret'], ['suite_ticket' => $suitTicket]);
        $accessToken = \Mockery::mock(AccessToken::class, [$app])->makePartial()->shouldAllowMockingProtectedMethods();
        $this->assertSame(['suite_id' => 'mock-suite-id', 'suite_secret' => 'mock-suite-secret', 'suite_ticket' => 'mock-suit-ticket'], $accessToken->getCredentials());
    }
}