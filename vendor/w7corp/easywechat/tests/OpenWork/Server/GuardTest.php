...
class GuardTest extends TestCase
{
    ...
    {
        $config = ['token' => 'QDG6eK', 'aes_key' => 'jWmYm7qr5nMoAUwZRjGtBxmz3KA1tkAj3ykkR6q2B2C'];
        $message = ['ToUserName' => 'wx5823bf96d3bd56c7', 'Encrypt' => ''];
        ...
        $app = new Application([$config], ['request' => $request, 'config' => new Config($config)]);
