...
class EchoStrHandlerTest extends TestCase
{
    ...
    {
        $config = ['token' => 'mock-token', 'aes_key' => 'mock-aes-key'];
        ...
        $app = new Application([$config], ['request' => $request, 'encryptor_corp' => $encryptor_corp]);
