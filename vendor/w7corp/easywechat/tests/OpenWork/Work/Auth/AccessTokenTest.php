...
class AccessTokenTest extends TestCase
{
    ...
    {
        $app = new ServiceContainer(['corp_id' => '1234', 'secret' => 'secret']);
        ...
        $this->assertSame(['auth_corpid' => 'mock-auth-corp-id', 'permanent_code' => 'mock-permanent-code'], $accessToken->getCredentials());
    }
    public function testEndpoint()
    {
        ...
        $openWork['suite_access_token'] = \Mockery::mock(\EasyWeChat\OpenWork\SuiteAuth\AccessToken::class, function ($mock) {
            $mock->shouldReceive('getToken')->andReturn(['suite_access_token' => 'mock-suit-access-token']);
        });
