...
class AccessTokenTest extends TestCase
{
    ...
    {
        $app = new ServiceContainer(['corp_id' => 'mock-corp-id', 'secret' => 'mock-secret']);
        $accessToken = \Mockery::mock(AccessToken::class, [$app])->makePartial()->shouldAllowMockingProtectedMethods();
        $this->assertSame(['corpid' => 'mock-corp-id', 'provider_secret' => 'mock-secret'], $accessToken->getCredentials());
    }
}