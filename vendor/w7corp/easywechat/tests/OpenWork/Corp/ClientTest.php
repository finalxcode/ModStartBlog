...
class ClientTest extends TestCase
{
    ...
    {
        $app = new ServiceContainer(['suite_id' => 'mock-suit-id', 'redirect_uri_install' => 'mock-redirect-uri']);
        $app['suite_access_token'] = \Mockery::mock(AccessToken::class);
    ...
    public function testSetSession()
    {
        ...
        $client->expects()->httpPostJson('cgi-bin/service/set_session_info', ['pre_auth_code' => 'mock-pre-auth-code', 'session_info' => ['appid' => [1, 2, 3], 'auth_type' => 1]])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->setSession('mock-pre-auth-code', ['appid' => [1, 2, 3], 'auth_type' => 1]));
    }
    public function testGetPermanentByCode()
    {
        ...
        $app['suite_access_token'] = \Mockery::mock(AccessToken::class);
        $client = $this->mockApiClient(Client::class, [], $app)->makePartial();
        $client->expects()->httpPostJson('cgi-bin/service/get_permanent_code', ['auth_code' => 'mock-auth-code'])->andReturn('mock-result');
    ...
    public function testGetAuthorization()
    {
        ...
        $app['suite_access_token'] = \Mockery::mock(AccessToken::class);
        $client = $this->mockApiClient(Client::class, [], $app)->makePartial();
        $client->expects()->httpPostJson('cgi-bin/service/get_auth_info', ['auth_corpid' => 'mock-auth-corp-id', 'permanent_code' => 'mock-permanent-code'])->andReturn('mock-result');
    ...
    public function testGetManagers()
    {
        ...
        $app['suite_access_token'] = \Mockery::mock(AccessToken::class);
        $client = $this->mockApiClient(Client::class, [], $app)->makePartial();
        $client->expects()->httpPostJson('cgi-bin/service/get_admin_list', ['auth_corpid' => 'mock-auth-corp-id', 'agentid' => 'mock-agent-id'])->andReturn('mock-result');
    ...
    {
        $app = new ServiceContainer(['suite_id' => 'mock-suit-id', 'redirect_uri_oauth' => 'mock-redirect-uri']);
        $app['suite_access_token'] = \Mockery::mock(AccessToken::class);
        $client = $this->mockApiClient(Client::class, [], $app);
    ...
    public function testGetUserByCode()
    {
        ...
        $app['suite_access_token'] = \Mockery::mock(AccessToken::class);
        $client = $this->mockApiClient(Client::class, [], $app)->makePartial();
        $client->expects()->httpGet('cgi-bin/service/getuserinfo3rd', ['code' => 'mock-code'])->andReturn('mock-result');
    ...
    public function testGetUserByTicket()
    {
        ...
        $app['suite_access_token'] = \Mockery::mock(AccessToken::class);
        $client = $this->mockApiClient(Client::class, [], $app)->makePartial();
        $client->expects()->httpPostJson('cgi-bin/service/getuserdetail3rd', ['user_ticket' => 'mock-user-ticket'])->andReturn('mock-result');
