...
class ClientTest extends TestCase
{
    ...
    {
        $client = $this->mockApiClient(Client::class, ['query']);
        $client->expects()->query('datacube/getcardbizuininfo', '2017-08-02', '2017-08-10', ['cond_source' => 67])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->cardSummary('2017-08-02', '2017-08-10', '67'));
    }
    public function testFreeCardSummary()
    {
        $client = $this->mockApiClient(Client::class, ['query']);
        $client->expects()->query('datacube/getcardcardinfo', '2017-08-02', '2017-08-10', ['cond_source' => 67, 'card_id' => 'mock-card_id'])->andReturn('mock-result');
    ...
    {
        $client = $this->mockApiClient(Client::class, ['query']);
        $client->expects()->query('datacube/getcardmembercardinfo', '2017-08-02', '2017-08-10', ['cond_source' => 67])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->memberCardSummary('2017-08-02', '2017-08-10', '67'));
    }
    public function testMemberCardSummaryById()
    {
        $client = $this->mockApiClient(Client::class, ['query']);
        $client->expects()->query('datacube/getcardmembercarddetail', '2017-08-02', '2017-08-10', ['card_id' => 'mock-card_id'])->andReturn('mock-result');
    ...
    public function testQuery()
    {
        ...
        $client->expects()->httpPostJson('path/to/api', ['begin_date' => '2017-08-02', 'end_date' => '2017-08-10', 'foo' => 'bar'])->andReturn('mock-result');
