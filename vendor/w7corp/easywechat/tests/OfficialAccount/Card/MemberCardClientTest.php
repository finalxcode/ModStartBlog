...
class MemberCardClientTest extends TestCase
{
    ...
    {
        $client = $this->mockApiClient(MemberCardClient::class);
        $params = ['card_id' => 'mock-card-id', 'foo' => 'bar'];
    ...
    {
        $client = $this->mockApiClient(MemberCardClient::class);
        $params = ['activate_ticket' => 'mock-activate-ticket'];
    ...
    {
        $client = $this->mockApiClient(MemberCardClient::class);
        $params = ['card_id' => 'mock-card-id', 'code' => 'mock-code'];
    ...
    {
        $client = $this->mockApiClient(MemberCardClient::class);
        $params = ['card_id' => 'mock-card-id', 'outer_str' => 'mock-outer_str'];
