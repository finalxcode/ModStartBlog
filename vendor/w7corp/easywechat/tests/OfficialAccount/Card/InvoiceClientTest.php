...
class InvoiceClientTest extends TestCase
{
    public function testSet()
    {
        ...
        $params = ['paymch_info' => ['mchid' => 'mock-mchid', 's_pappid' => 'mock-s-appid']];
    ...
    {
        $client = $this->mockApiClient(InvoiceClient::class);
        $params = ['auth_field' => ['user_field' => ['mock-user-data'], 'biz_field' => ['mock-biz-data']]];
    ...
    {
        $client = $this->mockApiClient(InvoiceClient::class);
        $params = ['order_id' => 'mock-order-id', 's_appid' => 'mock-s-appid'];
