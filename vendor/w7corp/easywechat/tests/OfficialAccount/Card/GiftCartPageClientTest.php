...
class GiftCartPageClientTest extends TestCase
{
    public function testAdd()
    {
        ...
        $params = ['page_title' => 'mock-page-title', 'support_multi' => true, 'banner_pic_url' => 'mock-banner-pic-url', 'theme_list' => 'mock-theme-list'];
    ...
    {
        $client = $this->mockApiClient(GiftCardPageClient::class);
        $params = ['page' => ['page_id' => 'mock-page-id', 'banner_pic_url' => 'mock-banner-pic-url', 'theme_list' => ['mock-theme-list']]];
