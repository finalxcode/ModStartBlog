...
class ClientTest extends TestCase
{
    public function testClearQuota()
    {
        ...
        $client->expects()->httpPostJson('cgi-bin/clear_quota', ['appid' => '123456'])->andReturn('mock-result');
    ...
    {
        $client = $this->mockApiClient(Client::class);
        $client->expects()->httpPostJson('cgi-bin/callback/check', ['action' => 'all', 'check_operator' => 'DEFAULT'])->andReturn('mock-result');
