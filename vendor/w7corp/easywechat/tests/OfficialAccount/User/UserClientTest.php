...
class UserClientTest extends TestCase
{
    public function testGet()
    {
        ...
        $client->expects()->httpGet('cgi-bin/user/info', ['openid' => 'mock-openid', 'lang' => 'zh_CN'])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->get('mock-openid'));
        $client->expects()->httpGet('cgi-bin/user/info', ['openid' => 'mock-openid', 'lang' => 'en'])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->get('mock-openid', 'en'));
    }
    public function testSelect()
    {
        $client = $this->mockApiClient(UserClient::class);
        $client->expects()->httpPostJson('cgi-bin/user/info/batchget', ['user_list' => [['openid' => 'mock-openid1', 'lang' => 'zh_CN'], ['openid' => 'mock-openid2', 'lang' => 'zh_CN']]])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->select(['mock-openid1', 'mock-openid2']));
        $client->expects()->httpPostJson('cgi-bin/user/info/batchget', ['user_list' => [['openid' => 'mock-openid1', 'lang' => 'en'], ['openid' => 'mock-openid2', 'lang' => 'en']]])->andReturn('mock-result');
    ...
    {
        $client = $this->mockApiClient(UserClient::class);
        $client->expects()->httpPostJson('cgi-bin/user/info/updateremark', ['openid' => 'mock-openid', 'remark' => 'mock-remark'])->andReturn('mock-result');
    ...
    {
        $client = $this->mockApiClient(UserClient::class);
        $client->expects()->httpPostJson('cgi-bin/tags/members/batchblacklist', ['openid_list' => ['mock-openid1']])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->block('mock-openid1'));
        $client->expects()->httpPostJson('cgi-bin/tags/members/batchblacklist', ['openid_list' => ['mock-openid1', 'mock-openid2']])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->block(['mock-openid1', 'mock-openid2']));
    }
    public function testUnblock()
    {
        $client = $this->mockApiClient(UserClient::class);
        $client->expects()->httpPostJson('cgi-bin/tags/members/batchunblacklist', ['openid_list' => ['mock-openid1']])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->unblock('mock-openid1'));
        $client->expects()->httpPostJson('cgi-bin/tags/members/batchunblacklist', ['openid_list' => ['mock-openid1', 'mock-openid2']])->andReturn('mock-result');
        $this->assertSame('mock-result', $client->unblock(['mock-openid1', 'mock-openid2']));
    }
    public function testChangeOpenid()
    {
        $client = $this->mockApiClient(UserClient::class);
        $client->expects()->httpPostJson('cgi-bin/changeopenid', ['from_appid' => 'old-appid', 'openid_list' => ['openid1', 'openid2']])->andReturn('mock-result');
