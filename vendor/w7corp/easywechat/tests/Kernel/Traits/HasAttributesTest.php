...
class HasAttributesTest extends TestCase
{
    ...
    {
        $cls = new DummyClassForHasAttributesTest();
        $cls->setAttributes(['foo' => 'bar', 'name' => 'easywechat']);
        $cls->merge(['age' => 27]);
    ...
    {
        $cls = new DummyClassForHasAttributesTest();
        $cls->setAttributes(['foo' => 'bar', 'name' => 'easywechat', 'age' => 27]);
        $this->assertSame(['foo' => 'bar'], $cls->only('foo'));
        $this->assertSame(['foo' => 'bar', 'age' => 27], $cls->only(['foo', 'age']));
    }
}
