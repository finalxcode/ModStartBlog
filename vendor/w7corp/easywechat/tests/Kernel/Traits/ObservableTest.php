...
class ObservableTest extends TestCase
{
    ...
    public function testNotifyWithHandlerExceptionThrown()
    {
        ...
        $logger->expects()->error('-204: handler2 exception thrown.', ['code' => -204, 'message' => 'handler2 exception thrown.', 'file' => __FILE__, 'line' => $line]);
        $app = new ServiceContainer([], ['logger' => $logger]);
