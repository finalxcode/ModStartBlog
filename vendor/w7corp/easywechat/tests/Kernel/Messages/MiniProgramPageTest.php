...
class MiniProgramPageTest extends TestCase
{
    ...
    {
        $msg = new MiniProgramPage(['title' => 'title', 'appid' => 'minprogram appid', 'pagepath' => 'miniprogram path', 'thumb_media_id' => 'miniprogram cover']);
    ...
    public function testTransformForJsonRequest()
    {
        ...
        $msg->pagepath = 'path';
        $this->assertSame(['msgtype' => 'miniprogrampage', 'miniprogrampage' => ['title' => 'title', 'appid' => 'appid', 'thumb_media_id' => 'image', 'pagepath' => 'path']], $msg->transformForJsonRequest());
    }
}