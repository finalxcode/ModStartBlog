...
class AccessTokenTest extends TestCase
{
    public function testGetCredentials()
    {
        ...
        $app = new ServiceContainer(['app_id' => 'mock-app-id', 'secret' => 'mock-secret'], ['verify_ticket' => $verifyTicket]);
        $token = \Mockery::mock(AccessToken::class, [$app])->makePartial()->shouldAllowMockingProtectedMethods();
        $this->assertSame(['component_appid' => 'mock-app-id', 'component_appsecret' => 'mock-secret', 'component_verify_ticket' => 'ticket@123456'], $token->getCredentials());
    }
}