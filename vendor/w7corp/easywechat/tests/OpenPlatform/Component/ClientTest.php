...
class ClientTest extends TestCase
{
    public function testRegisterMiniProgram()
    {
        ...
        $params = ['name' => 'aaa', 'code' => '111', 'code_type' => 1, 'legal_persona_wechat' => 'aaa111', 'legal_persona_name' => 'aaa111', 'component_phone' => '111'];
    ...
    {
        $client = $this->mockApiClient(Client::class, []);
        $params = ['name' => 'aaa', 'legal_persona_wechat' => 'aaa111', 'legal_persona_name' => 'aaa111'];
