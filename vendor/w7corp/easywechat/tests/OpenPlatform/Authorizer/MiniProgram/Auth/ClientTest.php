...
class ClientTest extends TestCase
{
    public function testSession()
    {
        ...
        $client->expects()->httpGet('sns/component/jscode2session', ['appid' => 'app-id', 'js_code' => 'js-code', 'grant_type' => 'authorization_code', 'component_appid' => 'component-app-id', 'component_access_token' => 'foobar'])->andReturn('mock-result');
