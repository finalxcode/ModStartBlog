...
class ClientTest extends TestCase
{
    public function testGetPreAuthorizationUrl()
    {
        ...
        $this->assertSame('https://mp.weixin.qq.com/cgi-bin/fastregisterauth?copy_wx_verify=0&component_appid=component-app-id&appid=app-id&redirect_uri=https%3A%2F%2Feasywechat.com%2Fcallback', $client->getFastRegistrationUrl('https://easywechat.com/callback', false));
    }
    public function testRegister()
    {
        $app = new Application(['app_id' => 'component-app-id']);
        $client = \Mockery::mock(Client::class . '[httpPostJson]', [new Application(['app_id' => 'app-id']), $app]);
        $client->expects()->httpPostJson('cgi-bin/account/fastregister', ['ticket' => 'ticket'])->andReturn('mock-result');
