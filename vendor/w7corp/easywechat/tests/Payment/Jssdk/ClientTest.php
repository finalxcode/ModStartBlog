...
class ClientTest extends TestCase
{
    ...
    {
        $app = new Application(['app_id' => 'wx123456', 'mch_id' => 'foo-mcherant-id', 'key' => 'foo-mcherant-key', 'sub_mch_id' => 'foo-sub-mch-id']);
        ...
        $this->assertSame('MD5', $config['signType']);
        // sub_appid
        $app = new Application(['app_id' => 'wx123456', 'merchant_id' => 'foo-mcherant-id', 'key' => 'foo-mcherant-key', 'sub_appid' => 'foo-sub-appid', 'sub_mch_id' => 'foo-sub-mch-id']);
        $client = $this->mockApiClient(Client::class, 'bridgeConfig', $app)->makePartial();
        $config = $client->bridgeConfig($prepayId, false);
