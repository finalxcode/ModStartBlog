...
class ClientTest extends TestCase
{
    ...
    {
        return new Application(array_merge(['app_id' => 'wx123456', 'mch_id' => 'foo-mcherant-id', 'key' => 'foo-mcherant-key', 'sub_appid' => 'foo-sub-appid', 'sub_mch_id' => 'foo-sub-mch-id', 'rsa_public_key_path' => \STUBS_ROOT . '/files/public-wx123456.pem'], $config));
    }
    ...
    public function testToBackCard()
    {
        $app = $this->makeApp();
        $client = $this->mockApiClient(Client::class, ['send', 'safeRequest'], $app)->makePartial();
        $params = ['partner_trade_no' => '1229222022', 'enc_bank_no' => '6214830102234434', 'enc_true_name' => '安正超', 'bank_code' => '1001', 'amount' => 100, 'desc' => '测试'];
