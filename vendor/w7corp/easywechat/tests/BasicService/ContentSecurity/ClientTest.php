...
class ClientTest extends TestCase
{
    public function testCheckText()
    {
        ...
        $client->makePartial();
        $client->expects()->httpPostJson('msg_sec_check', ['content' => 'foo'])->andReturn('mock-result');
    ...
    public function testCheckImage()
    {
        ...
        $client->makePartial();
        $imagePath = 'foo';
        $client->expects()->httpUpload('img_sec_check', ['media' => $imagePath])->andReturn('mock-result');
