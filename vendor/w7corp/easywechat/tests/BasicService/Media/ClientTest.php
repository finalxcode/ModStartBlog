...
class ClientTest extends TestCase
{
    ...
    public function testCreateVideoForBroadcasting()
    {
        ...
        $client->expects()->httpPostJson('media/uploadvideo', ['media_id' => $mediaId, 'title' => $title, 'description' => $description])->andReturn('mock-response');
    ...
    public function testGet()
    {
        ...
        $client->expects()->requestRaw('media/get', 'GET', ['query' => ['media_id' => $mediaId]])->andReturn($imageResponse);
    ...
    public function testGetJssdkMedia()
    {
        ...
        $mediaId = 'invalid-media-id';
        $imageResponse = new Response(200, ['content-type' => 'text/plain'], '{"error": "invalid media id hits."}');
        $client->expects()->requestRaw('media/get/jssdk', 'GET', ['query' => ['media_id' => $mediaId]])->andReturn($imageResponse);
