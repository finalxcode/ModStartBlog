...
class ClientTest extends TestCase
{
    public function testSend()
    {
        ...
        $client->expects()->httpPostJson('cgi-bin/message/wxopen/template/send', ['touser' => 'mock-openid', 'template_id' => 'mock-template_id', 'page' => '', 'form_id' => 'mock-form_id', 'emphasis_keyword' => '', 'data' => []])->andReturn('mock-result');
