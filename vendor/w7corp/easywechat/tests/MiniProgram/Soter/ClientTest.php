...
class ClientTest extends TestCase
{
    public function testVerifySignature()
    {
        ...
        $client->expects()->httpPostJson('cgi-bin/soter/verify_signature', ['openid' => 'mock-openid', 'json_string' => 'mock-json', 'json_signature' => 'mock-signature'])->andReturn('mock-result');
