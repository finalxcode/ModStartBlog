...
class ClientTest extends TestCase
{
    ...
    {
        $client = $this->mockApiClient(Client::class);
        $data = ['order_id' => '01234567890123456789', 'openid' => 'oABC123456', 'delivery_id' => 'SF', 'waybill_id' => '000000000'];
    ...
    {
        $client = $this->mockApiClient(Client::class);
        $data = ['delivery_id' => 'YTO', 'biz_id' => 'xyz'];
    ...
    {
        $client = $this->mockApiClient(Client::class);
        $data = ['openid' => 'myopenid', 'update_type' => 'bind'];
    ...
    {
        $client = $this->mockApiClient(Client::class);
        $data = ['openid' => 'myopenid', 'update_type' => 'unbind'];
        $client->expects()->httpPostJson('cgi-bin/express/business/printer/update', $data)->andReturn('mock-result');
